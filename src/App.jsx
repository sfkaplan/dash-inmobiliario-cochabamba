            ...
            <div className="finance-section">
              ...
              <div className="expander" style={{ marginBottom: 16 }}>
                <div className="expander-header" onClick={() => setOpenCalc(o => !o)}>
                  <span className="expander-header-title">Cálculo de alquiler (USD)</span>
                ...
                <div className={`expander-body${openCalc ? ' open' : ''}`}>
                  ...
                  <div className="metrics-row">
                    <div className="metric-card">
                      <div className="metric-label">Total nominal (USD)</div>
                      <div className="metric-value">{fmtUSD(totalNominal)}</div>
                    </div>
                    <div className="metric-card">
                      <div className="metric-label">Valor presente (USD)</div>
                      <div className="metric-value">{fmtUSD(totalDescontado)}</div>
                    </div>
                  </div>
                        ...
                        <table className="flow-table">
                          ...
                          <tbody>
                            {flows.map(f => (
                              <tr key={f.yr}>
                                <td>{f.yr}</td>
                                <td>{fmtUSD(f.flujo)}</td>
                                <td>{f.factor.toFixed(6)}</td>
                                <td>{fmtUSD(f.flujoDesc)}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
